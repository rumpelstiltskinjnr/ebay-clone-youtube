                ...
                key={listing.id}>
                    ...
                    <div className='pt-2 space-y-4'>
                      <div>
                        ...
                        <hr />
                        <p className="trucate text-sm text-gray-600 mt-2">{listing.asset.description}</p>
                      </div>
                      ...
                      <div className={`flex items-center space-x-1 justify-end text-xs border w-fit ml-auto p-2 rounded-lg text-white ${listing.type === ListingType.Direct 
                      ? "bg-blue-500"
                      : "bg-red-500"}`}>
                        <p className="">
